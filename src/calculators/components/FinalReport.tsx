...
export const FinalReport: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 space-y-8 pb-32 print:p-0 text-slate-900">
      ...
      <header className="flex flex-col border-b-2 border-slate-100 pb-6">
        ...
        <div className="flex justify-between items-start gap-4">
          <div className="flex-1">
            <h1 className="text-2xl font-black text-slate-400 tracking-tighter uppercase italic">Relatório Clínico</h1>
            <div className="mt-4">
          ...
          <button onClick={handlePrint} className="print:hidden bg-slate-900 text-white px-6 py-4 rounded-2xl font-black text-[10px] uppercase tracking-widest flex items-center gap-3 hover:bg-slate-800 transition-all shrink-0 shadow-lg">
      ...
      {/* CORE: CBDF - FIX PARA SOBREPOSIÇÃO */}
      <section className="bg-slate-950 rounded-[3.5rem] p-10 text-white shadow-2xl border-b-[12px] border-indigo-600 break-inside-avoid relative overflow-hidden">
        <div className="relative z-10 flex flex-col gap-6">
          ...
          <h2 className="text-5xl md:text-7xl lg:text-8xl font-black tracking-tighter font-mono text-indigo-100 leading-none">
            {cbdfFullCode}
          </h2>

          <div className="pt-6 border-t border-white/10 flex flex-wrap items-center gap-x-8 gap-y-4">
            <div className="flex flex-col">
              <span className="text-[10px] font-black text-indigo-400 uppercase tracking-widest">Diagnóstico</span>
            ...
            {sitToStand?.percentPredicted && (
              <div className="bg-white/10 px-5 py-2 rounded-2xl border border-white/5">
                <span className="text-3xl font-black text-emerald-400">{sitToStand.percentPredicted}%</span>
                <span className="text-[9px] block font-black text-white/50 uppercase tracking-tighter leading-none">do Predito</span>
              </div>
            )}
          </div>
        </div>
        ...
        <div className="bg-white rounded-[2.5rem] p-8 border border-slate-100 shadow-sm space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-[12px] font-black text-rose-700 uppercase italic">
                {(() => {
